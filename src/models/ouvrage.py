...
class Ouvrage:
    ...
    isbn_ouvrage: Mapped[str] = mapped_column() #VARCHAR(20),
    langue_ouvrage: Mapped[str] = mapped_column() #VARCHAR(20),
    prix_ouvrage: Mapped[float] = mapped_column() #DECIMAL(10, 2),
    date_parution_ouvrage: Mapped[datetime] = mapped_column() #DATE,
    categorie_ouvrage: Mapped[str] = mapped_column() #VARCHAR(255),
