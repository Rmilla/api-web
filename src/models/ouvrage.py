...
class Ouvrage(Base):
    ...
    titre_ouvrage: Mapped[str] = mapped_column(
    ...
    prix_ouvrage: Mapped[DECIMAL] = mapped_column(
        Numeric(precision=10, scale=2))  # DECIMAL(10, 2),
    date_parution_ouvrage: Mapped[str] = mapped_column(
        String(255))  # changer en format DATE,
    categorie_ouvrage: Mapped[str] = mapped_column(
        String(255))  # VARCHAR(255),
    date_disponibilite_libraire_ouvrage: Mapped[str] = mapped_column(
        String(255))  # DATE,
    date_disponibilite_particulier_ouvrage: Mapped[str] = mapped_column(
        String(255))  # changer en format DATE,
    image_ouvrage: Mapped[str] = mapped_column(String(255))  # VARCHAR(255),
    table_des_matieres_ouvrage: Mapped[str] = mapped_column(
        String(255))  # TEXT,
